...
//	List<Map<String,Object>> getResume(@Param("cityCode")String cityCode, @Param("search")String search, @Param("order")Integer order, @Param("accountIDList")List<Long> accountIDList);
	 ...
	 * @return
	 */
	List<Map<String,Object>> getResume(@Param("cityCode")String cityCode, @Param("search")String search, @Param("order")Integer order);
...
//	Integer getResumeCountByAll(@Param("accountIDList")List<Long> accountIDList);
	...
	/**
	 * 作者: cheng fei
	 * 创建日期: 2019/1/15 17:12
	 * 描述 : 根据账号ID查询简历ID
	 * @param accountID
	 * @return
	 */
	Long getResumeIDByAccountID(Long accountID);
}
