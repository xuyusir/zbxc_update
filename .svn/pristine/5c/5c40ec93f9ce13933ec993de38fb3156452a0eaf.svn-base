...
public class FileController extends BaseController {
	...
	@ApiOperation(value = "获取文件上传进度条", httpMethod = "GET", produces = "application/json")
	@RequestMapping(value = "/progress/bar",method = RequestMethod.GET)
	@ResponseBody
	public Result getProgressBar(){
		AccountInfo accountInfo = this.getAccountInfo();
		return  fileService.getProgressBar(accountInfo);
	}
