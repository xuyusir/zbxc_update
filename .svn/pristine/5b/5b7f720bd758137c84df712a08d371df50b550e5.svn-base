...
public class SendMailUtil2 {
    ...
    public void doSendHtmlEmail(String subject, String emailContent,
        ...
        try {
            ...
            InternetAddress from = new InternetAddress(MimeUtility.encodeWord("野哥")+" <"+sender_username+">");
    ...
    public static void main(String[] args) {
        ...
        se.doSendHtmlEmail("邮件主题", "邮件内容娃哈哈哈", new String[]{"xxxxx@qq.com"});
    }
}
