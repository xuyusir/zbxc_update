...
public interface AccountService {
	 ...
	 * @param isDelete 账号是否是否查询回收站
	 * @param search 关键字:用户名/姓名/邮箱
	 * @param page 页码
	 * @param page_size 每页显示条数
	 * @return
	 */
	Result getManageAccountList(AccountInfo accountInfo, boolean isDelete,String search, Integer page, Integer page_size);
	 ...
	 * @throws MyException
	 */
	Result exportManageAccountList(AccountInfo accountInfo, String AUTHORITY_CODE, String search) throws MyException;
	 ...
	 * @return
	 */
	Result getPersonAccountList(AccountInfo accountInfo, boolean isDelete, Integer account_type, String search, Integer page, Integer page_size);
	 ...
	 * @throws MyException
	 */
	Result exportPersonAccountList(AccountInfo accountInfo, String AUTHORITY_CODE, Integer  accountType, String search) throws MyException;
	...
	/**
	 * 查询企业账号列表
	 * @param isDelete 账号是否删除
	 * @param search 关键词
	 * @param page 页码
	 * @param page_size 每页条数
	 * @return
	 */
	Result getEnterpriseAccountList(boolean isDelete,String search, Integer page, Integer page_size);
	 ...
	 * @throws MyException
	 */
	Result exportEnterpriseAccountList(boolean isDelete, AccountInfo accountInfo, String AUTHORITY_CODE, String search) throws MyException;
	...
	/**
	 * 作者: cheng fei
	 * 创建日期: 2019/1/11 17:32
	 * 描述 : 回收企业账号
	 * @param accountInfo 当前登陆账号
	 * @param authorityCode 权限编码
	 * @param ids 要回收的账号id列表用","隔开
	 * @param type 回收账号类型:1.管理员账号,2.个人账号,3.企业账号
	 * @return
	 */
	Result recycleAccount(AccountInfo accountInfo, String authorityCode, String ids, int type) throws MyException;

	/**
	 * 作者: cheng fei
	 * 创建日期: 2019/1/14 11:10
	 * 描述 : 彻底删除企业账号
	 * @param accountInfo 当前登陆账号
	 * @param authorityCode 权限编码
	 * @param ids 要删除的账号列表用","号隔开
	 * @return
	 */
	Result finalDeleteEnterpriseAccount(AccountInfo accountInfo, String authorityCode, String ids) throws MyException;
}
