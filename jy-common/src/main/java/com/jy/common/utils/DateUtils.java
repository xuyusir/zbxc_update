...
//    }
    ...
    public static void main(String[] args) {
        ...
        jedis.auth("2f7ead25-de4b-485b-8f89-d738555ca45f");
        jedis.lpush("task-queue1", "123");//装入队列
        ...
        //获取队列消息
        System.out.println(jedis.rpoplpush("task-queue", "tmp-queue"));
        System.out.println(jedis.rpoplpush("task-queue1", "tmp-queue1"));
        System.out.println(jedis.rpoplpush("tmp-queue1", "tmp-queue2"));
